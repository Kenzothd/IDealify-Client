...
const Footer = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#254D71", py: "2rem" }}>
      <Container sx={{ display: "flex", justifyContent: "center" }}>
        <Typography sx={{ width: 550, textAlign: "center", color: "white" }}>
          Idealify is a project management platform that allows interior
          designers to plan their projects and build accountability with
          clients.
        </Typography>
      </Container>
