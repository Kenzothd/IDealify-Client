...
import ClientSingleProjectView from "./ClientSingleProjectView";

const SERVER = import.meta.env.VITE_SERVER;
const ClientActivityTable: FC = () => {
    ...
    },
    {
      ...
      renderCell: (params) => {
        const onClick = (e: React.MouseEvent) => {
          ...
          navigate(`/client/${clientid}/projects/${projectid}/activity/${id}`);
        };
        return (
          <VisibilityIcon
            onClick={onClick}
