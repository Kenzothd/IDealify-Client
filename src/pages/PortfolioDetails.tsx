      ...
      <Grid container sx={{ mt: "5rem", mb: "3rem" }}>
        ...
        <Grid container spacing={6} sx={{ mb: "5rem" }}>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: "5rem" }}>
            ...
            <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
        ...
        <Grid container>
          ...
          <Grid item xs={12} sx={{ mb: "3rem" }}>
            <Box>
              ...
              <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
                {vendorPortfolio.vendorId.brandSummary}
              </Typography>
            </Box>
          </Grid>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
                {vendorPortfolio.vendorId.companyName}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
                {vendorPortfolio.vendorId.contactPersonName}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
                {vendorPortfolio.vendorId.contactNumber}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="h5" sx={{ mb: "0.5rem", color: "#444444" }}>
                {vendorPortfolio.vendorId.email}
              </Typography>
            </Grid>
          </Grid>
        </Grid>
